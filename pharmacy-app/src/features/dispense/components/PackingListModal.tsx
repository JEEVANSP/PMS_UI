...
export default function PackingListModal({
  isOpen, dispense, isLoading, onClose, onExecute,
  ...
  const asSummary = (): DispenseSummaryDto | null => {
    ...
    return {
      ...
      patientName:    dispense.patientId,
      ...
      <div className="flex items-start justify-between px-6 pt-5 pb-4 flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">{dispense ? `Order #${dispense.id}` : "Loading…"}</p>
          </div>
        </div>
          ...
          <>
              ...
              <div className="flex items-center gap-6 flex-wrap">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900 text-sm font-mono">{dispense.patientId}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
            ...
            <div className="bg-blue-50 rounded-2xl p-4 flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-gray-900">
                  {dispense.items.length} {dispense.items.length === 1 ? "Item" : "Items"} to Pack
                </p>
            ...
            <div className="space-y-3">
              {dispense.items.map((item, idx) => (
                <div key={item.prescriptionLineId}
                  ...
                  <div className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-bold text-gray-900 font-mono text-sm">{item.productId}</p>
                    ...
                    <div className="text-right">
                      <p className="text-4xl font-bold text-blue-600 leading-none">{item.quantityDispensed}</p>
      ...
      <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-100 flex-shrink-0 bg-white">
        ...
        {dispense && !isLoading && (
          <Button variant="primary" size="md"
            ...
            onClick={async () => { const s = asSummary(); if (s) await onExecute(s); }}>
